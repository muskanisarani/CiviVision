    ...
    <div className="home-wrapper">
      ...
      <section className="hero-custom">
        ...
        <div className="hero-buttons-custom">
          <Link to="/select-role" className="btn-custom primary-custom">Launch Portal</Link>
          <Link to="/how-to-use" className="btn-custom outline-custom">See How It Works</Link>
        </div>
      </section>
