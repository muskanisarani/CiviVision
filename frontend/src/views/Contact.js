  ...
  return (
    <div style={styles.body}>
      <div style={styles.header}>
        ...
        <h3 style={{ margin: 0, fontSize: '18px', fontWeight: '800', letterSpacing: '-0.25px' }}>System Support & Contact</h3>
      </div>

      <div style={styles.container}>
        <p style={{ fontSize: '14px', color: '#475569', marginBottom: '24px', lineHeight: '1.6' }}>
          Report website problems, login difficulties, or wrong image diagnostic readings directly to the GMC support team.
        </p>
          ...
          <div>
            <div style={styles.infoBlock}>
              ...
              <div style={{ marginTop: '35px', textAlign: 'center' }}>
                <span onClick={() => navigate('/faqs')} className="toggle-link-custom" style={{ cursor: 'pointer', fontSize: '13px', fontWeight: '600' }}>
